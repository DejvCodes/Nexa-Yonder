...
sr.reveal('.section-title-about-us, .cards-size-help', {delay:400, distance:'100px',interval: 100});
...
sr.reveal('.about-description, .footer-data, .process-description', {interval:100});